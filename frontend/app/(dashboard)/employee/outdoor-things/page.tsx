...
export default function EmployeeOutdoorThingsPage() {
  ...
  const fetchActivities = async () => {
    try {
      setFetching(true);
      // Show all activities (no filter - visible to all roles)
      const endpoint = 'get_outdoor_activities';
    ...
    <div className="p-4 sm:p-6 space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-600">
          This section shows your outdoor work like client site visits and field work.
        </p>
      </div>
