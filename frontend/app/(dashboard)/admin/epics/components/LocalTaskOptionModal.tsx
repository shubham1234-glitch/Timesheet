...
interface LocalTaskOptionModalProps {
  open: boolean;
  onClose: () => void;
  onCreateNew: () => void;
  onUseExisting: () => void;
...
export default function LocalTaskOptionModal({
  open,
  onClose,
  onCreateNew,
  onUseExisting,
}: LocalTaskOptionModalProps) {
      ...
      >
        <div className="py-4">
          <p className="text-sm text-gray-600 mb-6 text-center">
            Choose how you want to add your task to this epic
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xs text-gray-600">
                  Start from scratch with a blank task row in this epic
                </p>
              </div>
            </button>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-xs text-gray-600">
                  Start from existing task templates and adjust as needed
                </p>
              </div>
            </button>
          </div>
