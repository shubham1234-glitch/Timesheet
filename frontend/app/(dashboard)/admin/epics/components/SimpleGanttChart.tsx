  ...
  return (
    <div className="w-full overflow-x-auto bg-white border border-gray-200 rounded-lg">
            ...
            {chartData.monthRanges.map((range) => {
              ...
              return (
                <div
                  ...
                  className="absolute border-r border-gray-300 bg-gray-50 flex items-center justify-center"
                  style={{
                    left: `${startPx}px`,
                    width: `${widthPx}px`,
                    top: '32px',
                ...
                >
                  <span className="text-xs font-semibold text-gray-800 text-center">{range.month}</span>
                </div>
              );
            })}
          </div>
      ...
      <div className="space-y-0" style={{ minWidth: `${totalWidth}px` }}>
        {chartData.taskRows.map((task, taskIdx) => (
          <div 
            key={task.id} 
