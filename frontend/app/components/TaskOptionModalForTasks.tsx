...
interface TaskOptionModalForTasksProps {
  open: boolean;
  onClose: () => void;
  onCreated?: () => void;
}

export default function TaskOptionModalForTasks({ 
  open, 
  onClose, 
  onCreated 
}: TaskOptionModalForTasksProps) {
  ...
  const handleCreateNew = () => {
    onClose();
    router.push(buildRoleHref(roleBase, `/tasks/create-new`));
  };

  const handleUseExisting = () => {
    onClose();
    router.push(buildRoleHref(roleBase, `/tasks/use-existing`));
  };
